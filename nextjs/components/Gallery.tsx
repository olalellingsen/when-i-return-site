...
export default function Gallery({ images }: { images: SanityImage[] }) {
  return (
    <ul className="w-full py-4 flex flex-row gap-2 md:gap-4 overflow-x-auto overflow-y-hidden snap-x snap-mandatory scroll-smooth no-scrollbar lg:grid lg:grid-cols-3">
